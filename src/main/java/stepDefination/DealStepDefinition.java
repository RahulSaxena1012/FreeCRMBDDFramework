...
//	public void user_moves_to_the_deal_page() {
...
//		amount.sendKeys(dealsData.get(0).get(1));
//		probability.sendKeys(dealsData.get(0).get(2));
//		commission.sendKeys(dealsData.get(0).get(3));
//		savebtn.click();
//	}
//
